...
describe( 'deepset pdf', function tests() {
	...
	it( 'should compute the Erlang pdf and deep set', function test() {
		var data, expected, i;
	...
	it( 'should return an empty array if provided an empty array', function test() {
		assert.deepEqual( pdf( [], k, lambda, 'x' ), [] );
		assert.deepEqual( pdf( [], k, lambda, 'x', '/' ), [] );
	});
